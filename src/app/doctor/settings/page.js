...
export default function SettingsPage() {
  ...
  const savePrefs = async () => {
    ...
    } catch (e) { setMsg(toErrorText(e?.response?.data?.detail, 'Could not save preferences.')); }
  ...
  const changePw = async () => {
    ...
    } catch (e) { setMsg(toErrorText(e?.response?.data?.detail, 'Could not change password.')); }
    finally { setSaving(false); }
  };
